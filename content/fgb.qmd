...
df1 = pd.read_excel(metaFile, sheet_name="FGB")
...
---
title: "Flower Garden Banks National Marine Sanctuary Soundscape Report"
date: "today"
output: 
  html_document: 
    fig_caption: true
...
```{python}
#| echo: false
display(HTML(standardTextDict["FGNMS"]))
```

### Summary of monitoring sites
```{python}
#| echo: false
display(HTML(gf.makeImage("FGBNMSSiteMap.jpg", "FGB Site Map", 850)))
