...
df1 = pd.read_excel(metaFile, sheet_name="NP")
...
---
title: "Gulf of Alaska Fisheries Soundscape Report"
date: "today"
output: 
  html_document: 
    fig_caption: true
...
```{python}
#| echo: false
display(HTML(standardTextDict["Gulf of Alaska"]))
```
...
```{python}
#| echo: false
display(HTML(gf.makeImage("GulfOfAlaskaSiteMap.jpg", "NP Site Map", 850)))
