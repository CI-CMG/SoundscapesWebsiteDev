...
sites = ["FK01","FK05","FK06", "FK08"]
GGrouperGraphs = ["Daily_Activity", "Diel_Patterns"]
GGrouperGraphsLabels = ["Daily Activity", "Diel Patterns"]
altTexts = ["GGrouper daily activity", "GGrouper diel patterns"]
...
df1 = pd.read_excel(metaFile, sheet_name="FK")
...
---
title: "Florida Keys National Marine Sanctuary Soundscape Report"
date: "today"
output: 
  html_document: 
    fig_caption: true
...
```{python}
#| echo: false
display(HTML(standardTextDict["FKNMS"]))
```
...
```{python}
#| echo: false
display(HTML(gf.makeImage("FKNMSSiteMap.jpg", "FK Site Map", 850)))
...
### When are goliath grouper calling on their spawning aggregation site?

```{python}
#| echo: false

display(HTML(standardTextDict["goliath grouper"]))

display(HTML(gf.makeImage("FK01_Daily_Activity.png", "g_grouper", altText= "Plot of total goliath grouper calls detected per day between July and October of 2023 and 2024 in the Florida Keys National Marine Sanctuary, with most calls recorded between August and September.")))
display(HTML(standardTextDict["grouper daily activity fc"]))
display(HTML(standardTextDict["spacer"]))

display(HTML(gf.makeImage("FK01_Diel_Patterns.png", "g_grouper2", altText= "Aggregated bar plot of goliath grouper calls detected per hour of the day in 2023 and 2024 in the Florida Keys National Marine Sanctuary, with the majority of calls happening at night.")))
display(HTML(standardTextDict["grouper diel pattern fc"]))


#display(HTML(gf.makeButtonsWithLabels(GGrouperGraphs, GGrouperGraphsLabels, "FK01_***.png", "g_grouper", altTexts)))
#gf.makeImage("FK01_diel_patterns.png", "diel patterns")
```
...
# display(HTML(gf.makePlotlyButtonsWithLabels(["FK06", "FK08"],["FK06", "FK08"],"plot_***_interactiveAnnualSPL.html","InteractiveAnnualSPL")))
```
:::