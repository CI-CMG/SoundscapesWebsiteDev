...
df1 = pd.read_excel(metaFile, sheet_name="GR")
...
---
title: "Gray's Reef National Marine Sanctuary Soundscape Report"
date: "today"
output: 
  html_document: 
    fig_caption: true
...
```{python}
#| echo: false
display(HTML(standardTextDict["GRNMS"]))
```
...
display(HTML(gf.makeImage("GRNMSSiteMap.jpg", "GR Site Map", 850)))
...
display(HTML(standardTextDict["NARW"]))
display(HTML(gf.makeImage("GR01_NARW_presence.png", "daily activity", 900, altText= "Bar plot of North Atlantic Right Whale daily acoustic presence by week of the year in the Greys Reef National Marine Sanctuary; whales were detected between December and February, 2019-2024.")))

display(HTML(standardTextDict["NARW fc"]))
