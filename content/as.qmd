...
display(HTML(gf.makeImage("raster_by_site_Fish_damselfish.png", "rasterfishAS", altText= "Heatmap of damselfish detections at AS01 in Fagatele Bay, showing higher activity during daylight hours from late March to May 2023.")))
