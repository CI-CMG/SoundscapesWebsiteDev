...
display(HTML(gf.makeImage("raster_by_site_Fish_damselfish.png", "rasterfishAS", altText= "Heatmap of daytime damselfish detections at AS01 in Fagatele Bay from late March to May 2023, showing peak activity during mid-day to afternoon hours.")))
...
display(HTML(gf.makeImage("Vessel_NMSAS.png", "vesselAS", altText= "Heatmap of vessel detections at AS01 in Fagatele Bay, showing higher activity during daylight hours from late March to May 2023.")))
