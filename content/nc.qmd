...
df1 = pd.read_excel(metaFile, sheet_name="NC")
...
---
title: "Humboldt ______ Soundscape Report"
date: "today"
output: 
  html_document: 
    fig_caption: true
...
```{python}
#| echo: false
display(HTML(standardTextDict["NC"]))
```
...
```{python}
#| echo: false
#display(HTML(gf.makeImage("___FisheriesSiteMap.jpg", "NE Site Map", 850)))
