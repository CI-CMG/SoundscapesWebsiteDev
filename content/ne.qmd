...
display(HTML(standardTextDict["_________"]))

display(HTML(gf.makeImage("__________.png", "NEIndicator", altText= "Plot of total goliath grouper calls detected per day between July and October of 2023 and 2024 in the Florida Keys National Marine Sanctuary, with most calls recorded between August and September.")))
