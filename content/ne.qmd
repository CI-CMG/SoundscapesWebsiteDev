...
sites = ["NRS08", "COX01", "COX03", "NS02", "NS05", "NS08", "USTR06", "USTR09"]
sitesFOI = ["COX01", "COX03", "NS02", "NS08"]
sitesFOI2 = ["NRS08","USTR06", "USTR09"]
...
df1 = pd.read_excel(metaFile, sheet_name="NE")
...
---
title: "New England Fisheries Soundscape Report"
date: "today"
output: 
  html_document: 
    fig_caption: true
...
```{python}
#| echo: false
display(HTML(standardTextDict["Northeast"]))
```
...
```{python}
#| echo: false
display(HTML(gf.makeImage("NEFisheriesSiteMap.jpg", "NE Site Map", 850)))
...
<!-- display(HTML(gf.makeButtons(["SB01", "SBO3"], "plot_***_AISMonthAbove.jpg", "SoundLevelVariance"))) -->
<!-- infoHtml3 = f''' -->
...
<!--                 {gf.makeButtons(["SB01", "SBO3"], "table_***_AISMonthAbove.jpg", "AISMonthlyTables")} -->
...
<!-- display(HTML(gf.makeButtons(["SB01", "SBO3"], "plot_***_AIShist.jpg", "Histogram"))) -->
<!-- infoHtml4 = f''' -->
...
<!--                 {gf.makeButtons(["SB01", "SBO3"], "table_***_AIShist.jpg", "AISHistTables")} -->
