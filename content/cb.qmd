...
---
title: "Greater Farallones and Cordell Bank National Marine Sanctuaries Soundscape Report"
date: "today"
output: 
  html_document: 
    fig_caption: true
...
```{python}
#| echo: false
display(HTML(standardTextDict["CBNMS/GFNMS"]))
```

### Summary of monitoring sites
```{python}
#| echo: false
display(HTML(gf.makeImage("CBNMSSiteMap.jpg", "CB Site Map", 850)))
...
```
<!-- ### What are the trends in ocean noise? -->
<!-- ```{python} -->
<!-- #| echo: false -->
<!-- display(HTML(standardTextDict["Above year 1"])) -->
<!-- #display(HTML(gf.makeButtons(sites, "plot_***_year1.jpg", "Above year 1")))  -->
<!-- ``` -->
